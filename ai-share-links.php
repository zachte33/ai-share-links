...
define('AI_SHARE_LINKS_VERSION', '1.1.0');
...
final class AI_Share_Links {
    ...
    public function enqueue_frontend_assets() {
        ...
        // Always enqueue the timeout script (includes GA tracking if enabled)
        wp_add_inline_script('wp-block-library', $this->get_timeout_script());
    }
    ...
    private function get_color_schemes() {
        return apply_filters('ai_share_links_color_schemes', array(
            ...
            'brand' => array(
                'name' => __('Brand Blue', AI_SHARE_LINKS_TEXT_DOMAIN),
            ...
            'brand-transparent' => array(
                'name' => __('Brand Transparent', AI_SHARE_LINKS_TEXT_DOMAIN),
